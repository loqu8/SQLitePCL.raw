...
//                items_csproj.Add(config_csproj.create_batteries(batteriesArea, ver, "profile111", null));
    ...
    {
		Console.WriteLine("Version: {0}", NUSPEC_VERSION);
        ...
        if (args.Length > 0)                                        // custom build args { what, libRoot, libPattern }
        {
            string what = args[0];
